 ...
 * @author admin
 */
public class NimGame56611807 extends JFrame {
...
//         public void start() {
//        
//        while (IntStream.of(pilesArray).sum() > 0) {         // sum all piles
//            //playTurn();
//            //printPiles();
//            isFirstPlayerTurn = !isFirstPlayerTurn;     // switch turn
//        }
//        if(gamemode==1){
//        Msg.setText(isFirstPlayerTurn ?"Player 1 won!":"Player 2 won!"); }   // declare winnner
...
//    }
    ...
    //main function
            ...
            //NimGame56611807 a = new NimGame56611807();
            NimGame56611807 frame = new NimGame56611807();
            frame.setTitle("NimFrame");
...
//                piles[a] = random.nextInt(7) + 1; // generate random number between 1 and 7
//            }
//        }
//    }
     ...
     //****For my design, once you clicked on a row, you cannot revert row clicked(you can only choose this row)
     // but you can change the no of buttons clicked 
